...
--5 Najbardziej rozbudowana instrukcja. Wyzwalacz ustawiaj¹cy login i has³o pracownika na NULL po wstawieniu daty zwolnienia. W tym pliku znajdujê siê tylko instrukcja potrzebna do stworzenia triggera
 ...
 -- Aby taka opeacja by³a mo¿liwa nale¿a³o stworzyæ globaln¹ tabelê przechowuj¹c¹ 3 wartoœci, ID_pracownika, logi i has³o. Tabela ta jest aktualizowana po wywo³aniu procedury zwolnij_pracownika. Procedura ta zawiera instrukcje update ustawiaj¹c¹ datê zwolniania na aktualn¹ datê systemow¹. Natêpnie Nale¿y wywo³aæ procedurê usun_login_haslo, która pobiera dane z tabeli globalnej i wstawia do pracowników. Ca³oœæ wymaga wywo³ania dwóch procedur, najpier zwolnij_pracownika podaj¹c ID_pracownika jako parametr, nastêpnie nalezy wywo³aæ procedurê usun_login_haslo.